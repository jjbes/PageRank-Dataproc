...
gsutil cp pagerank-pyspark.py gs://x3ia020-pagerank

gsutil cp pagerank-pyspark-partitionned.py gs://x3ia020-pagerank
...
# Small Dataset
#
#gcloud dataproc jobs submit pyspark --region europe-west1 --cluster cluster-x3ia020 gs://x3ia020-pagerank/pagerank-pyspark.py \
#    -- gs://x3ia020-pagerank/small_page_links.nt 3

# Small Dataset with partitioning
#
gcloud dataproc jobs submit pyspark --region europe-west1 --cluster cluster-x3ia020 gs://x3ia020-pagerank/pagerank-pyspark-partitionned.py \
    -- gs://x3ia020-pagerank/small_page_links.nt 3 10

# Large Dataset
#
#gcloud dataproc jobs submit pyspark --region europe-west1 --cluster cluster-x3ia020 gs://x3ia020-pagerank/pagerank-pyspark.py \
#-- gs://public_lddm_data/page_links_en.nt.bz2 3

# Large Dataset with partitioning
#
#gcloud dataproc jobs submit pyspark --region europe-west1 --cluster cluster-x3ia020 gs://x3ia020-pagerank/pagerank-pyspark-partitionned.py \
#-- gs://public_lddm_data/page_links_en.nt.bz2 3 100
